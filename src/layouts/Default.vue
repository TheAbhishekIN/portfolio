    ...
    <footer class="bg-green-700 text-white">
     ...
     <!--        <a href="/rss.xml" class="text-white hover:text-gray-400 font-normal">RSS Feed</a> |
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:info@abhisharma.co" class="text-white hover:text-gray-400">
...
<!--           <li>
          ...
          <li>
            <a href="https://github.com/TheAbhishekIN/portfolio" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/TheABhishekIN" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/abhisharma.co" target="_blank" class="text-white hover:text-gray-400">
